<template>
  <div class="header">
    <router-link @click="scrollToTop()" to="/" class="logo"
      ><img src="/Rico-Taco-Mexican-Kitchen.png.webp" height="50" alt="" />
    </router-link>
    ...
    <div class="icons">
      ...
      <div v-if="!users.user" class="fas fa-user account" @click="showLog">
...
export default {
  ...
  setup() {
    ...
    return { scrollToTop, users, showNav, showLog, handleScroll, handleLogout };
  },
};
</script>
