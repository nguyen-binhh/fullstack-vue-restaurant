<template>
  <div>
    <div class="home-main">
      ...
      <div class="image">
        <img src="/images/b.png" alt="" class="home-img" />
        <img src="/images/a.png" alt="" class="home-parallax-img" />
      </div>
    </div>

    <div class="home-category">
      <router-link @click="scrollToTop()" to="/menu" class="box">
        <img src="/images/taco-img.png" alt="" />
        <h3>taco</h3>
      </router-link>

      <router-link @click="scrollToTop()" to="/menu" class="box">
        <img src="/images/burrito-img.png" alt="" />
        <h3>burrito</h3>
      </router-link>

      <router-link @click="scrollToTop()" to="/menu" class="box">
        <img src="/images/nachos-img.png" alt="" />
        <h3>nachos</h3>
      </router-link>

      <router-link @click="scrollToTop()" to="/menu" class="box">
        <img src="/images/salad-img.png" alt="" />
        <h3>sides</h3>
      </router-link>
      ...
      <router-link @click="scrollToTop()" to="/menu" class="box">
        <img src="/images/coca-img.png" alt="" />
        <h3>drink</h3>
      </router-link>
    </div>
